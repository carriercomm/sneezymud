...
byte TBeing::getSkillValue(spellNumT skill) const
{
  int value;
  int iMax;
...
byte TBeing::getRawNatSkillValue(spellNumT skill) const
{
  CSkill *sk;
...
byte TBeing::getNatSkillValue(spellNumT skill) const
{
  int value;
  int iMax;
