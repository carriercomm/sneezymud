...
class TBeing : public TThing {
  ...
  public:
    ...
    virtual const sstring getLongDesc() const;
    virtual int chiMe(TBeing *);
    virtual const sstring getName() const;
    ...
    int getPetAge();
    bool doRetrainPet(const sstring &, TBeing *);
    ...
    const sstring getProfAbbrevName() const;
    ...
    race_t getRaceIndex(const sstring &name) const;
    bool isWinged() const;
    ...
    void fixLevels(int);
    bool anythingGetable(const TObj *, const sstring &) const;
    ...
    int triggerSpecial(TThing *, cmdTypeT cmd, const sstring &arg); 
    ...
    int getClassNum(const sstring &, exactTypeT);
    int getClassNum(classIndT);
    classIndT getClassIndNum(const sstring &, exactTypeT);
    classIndT getClassIndNum(ush_int, exactTypeT);
    bool hasClass(const sstring &, exactTypeT) const;
    ...
    void transformLimbsBack(const sstring &, wearSlotT, bool);
    ...
    int portalLeaveCheck(sstring &, cmdTypeT);
    int updateAffects();
    int updateTickStuff();
    int updateBodyParts();
    ...
    void loadSetEquipment(int, sstring &, int);
    ...
    dirTypeT findDoor(const sstring &, const sstring &, doorIntentT, silentTypeT silent = SILENT_YES);
    ...
    void displayHelpFile(sstring &, sstring &);
    void genericKillFix();
    ...
    void doCompare(const sstring &);
    void doMortalCompare(const sstring &);
    void doTestFight(const sstring &);
    void doList(const sstring &);
    void doFactions(const sstring &);
    void doClients();
    int doCrit(sstring);
    void incorrectCommand() const;
    void doEgoTrip(const sstring &);
    void doComment(const sstring &);
    int doCommand(cmdTypeT, const sstring &, TThing *, bool);
    int doCharge(const sstring &, TBeing *);
    void doChargeStave(sstring);
    int doSmite(const sstring &, TBeing *);
    void doDescription();
    int doDissect(sstring);
    int socialLimbBad(TBeing *, cmdTypeT);
    int doPray(const sstring &);
    int preCastCheck();
    int preDiscCheck(spellNumT);
    int doCast(const sstring &);
    spellNumT parseSpellNum(sstring &);
    int parseTarget(spellNumT, sstring &, TThing **ret);
    int doTrigger(const sstring &);
    int doStore(const sstring &);
    int passOut();
    ...
    void sendTrapMessage(const sstring &, trap_targ_t, int);
    bool hasTrapComps(const sstring &, trap_targ_t, int, int *price = NULL);
    ...
    void openUniqueDoor(dirTypeT, doorUniqueT, const sstring &, const sstring &, const sstring &, const sstring &, const sstring &, const sstring &, const sstring &, const sstring &);
    int doDonate(int);
    int doMorgue();
    ...
    int doExec();
    void doEvaluate(const sstring &);
    void igniteObject(const sstring &, TThing *);
    ...
    void doMakeLeader(const sstring &);
    void doNewMember(const sstring &);
    void doRMember(const sstring &);
    void doDisband();
    void doSend(sstring);
    void doHelp(const sstring &);
    int doEncamp();
    int doSoothBeast(const sstring &);
    int doBefriendBeast(const sstring &);
    int doCharmBeast(const sstring &);
    int doTransfix(const sstring &);
    int doSummonBeast(const sstring &);
    int doBarkskin(const sstring &);
    int doFeralWrath(const sstring &);
    int doSkySpirit(const sstring &);
    int doEarthmaw(const sstring &);
    int doTransform(const sstring &);
    ...
    void stopsound();
    void stopmusic();
    void doPlay(const sstring &);
    void doSort(const sstring &) const;
    void doGamestats(const sstring &);
    void doScan(const sstring &);
    int dislodgeWeapon(TBeing *, TThing *, wearSlotT);
    void doInsult(const sstring &);
    void doStay();
    void doEmail(const sstring &);
    void doDeal(const sstring &);
    void doPass(const sstring &);
    int doAs(const sstring &);
    int doAsOther(const sstring &);
    void doAttack(const sstring &);
    void doBet(const sstring &);
    void doCall(const sstring &);
    void doFold(const sstring &);
    void doBreak(const sstring &, int);
    void doAccount(const sstring &);
    virtual void doOEdit(const sstring &);
    void doScratch(const sstring &);
    ...
    int doPick(const sstring &);
    int doSearch(const sstring &);
    int doSpy();
    int doDodge();
    int doParry();
    int SpyCheck();
    int disarmTrap(const sstring &, TObj *);
    int detectTrap(const sstring &, int);
    int doSetTraps(const sstring &);
    int doBerserk();
    int doShoot(const sstring &);
    void doSeekwater();
    void doTrack(const sstring &);
    void doConceal(sstring);
    void doDivine(const sstring &);
    void doForage();
    void doTan();
    void doButcher();
    ...
    void doSacrifice(const sstring &);
    void doWhittle(const sstring &);
    void doBload(const sstring &);
    vector <TBow *> getBows();
    TArrow * autoGetAmmoQuiver(TBow *, TQuiver *);
    TArrow * autoGetAmmo(TBow *);
    void doGload(sstring);
    void doPrerequisite(const sstring &, int);
    void doBrew(const sstring &);
    void doScribe(const sstring &);
    void doFly();
    void doLand();
    int crashLanding(positionTypeT, bool force = FALSE, bool dam = TRUE);
    int doTurn(const sstring &, TBeing *);
    virtual void doMedit(const sstring &);
    virtual void doSEdit(const sstring &);
    void edit_faction(const sstring &);
    void show_faction(const sstring &);
    void add_faction(const sstring &);
    void doJoin(const sstring &);
    void doRecruit(const sstring &);
    void doDefect(const sstring &);
    ...
    void doMeditate();
    void doPenance();
    int doShove(const sstring &, TBeing *);
    int doGrapple(const sstring &, TBeing *);
    int doRescue(const sstring &);
    void doReset(sstring);
    void doBoot(const sstring &);
    void doResize(const sstring &);
    int doDeathstroke(const sstring &, TBeing *);
    void doBandage(const sstring &);
    int doBodyslam(const sstring &, TBeing *);
    int doSpin(const sstring &, TBeing *);
    int doStomp(const sstring &, TBeing *);
    int doHeadbutt(const sstring &, TBeing *);
    int doKneestrike(const sstring &, TBeing *);
    int doDoorbash(const sstring &);
    void doTranceOfBlades(const sstring &);
    void doAttune(const sstring &);
    void doSharpen(const sstring &);
    void doCombine(const sstring &);
    void doAdjust(const sstring &);
    void doDull(const sstring &);
    void doRepair(const sstring &);
    void doEat(const sstring &);
    int doDrink(const sstring &);
    void foodNDrink(sectorTypeT, int);
    void doSip(const sstring &);
    int doPour(const sstring &);
    void doFill(const sstring &);
    void doTaste(const sstring &);
    void doBreath(const sstring &);
    void doQuest(const sstring &);
    void doMortalQuest(const sstring &);
    ...
    void lowRace(const sstring &);
    void lowMobs(const sstring &);
    void lowObjs(const sstring &);
    void lowWeaps(const sstring &);
    void lowPath(const sstring &);
    int doLower(const sstring &);
    int doRaise(const sstring &, cmdTypeT);
    virtual void doLow(const sstring &);
    bool isNaked() const;
    bool isWieldingWeapon();
    bool hasPart(wearSlotT) const;
    void doResetMargins();
    void doWeather(const sstring &);
    void doHeaven(const sstring &);
    void wearNTear(void);
    void doPrompt(const sstring &);
    ...
    int damageItem(TBeing *, wearSlotT, spellNumT, TThing *, int, const sstring & = NULL);
    ...
    void makeOtherPart(const sstring &, const sstring &, TBeing * = NULL);
    bool checkCut(TBeing *, wearSlotT, spellNumT, TThing *, int);
    bool checkPierced(TBeing *, wearSlotT, spellNumT, TThing *, int);
    bool checkSmashed(TBeing *, wearSlotT, spellNumT, TThing *, int, const sstring & = NULL);
    ...
    int unloadBow(const sstring &);
    int legalDeckAddition(int);

    // User commands go here
    void doSysMid();
    void doFindEmail(const sstring &);
    void doNameChange(const sstring &);
    void doSysTraceroute(const sstring &);
    void doSysLoglist();
    void doSysTasks(const sstring &);
    void doSysChecklog(const sstring &);
    void doSysViewoutput();
    int doSubterfuge(const sstring &);
    int doBackstab(const sstring &, TBeing *);
    int doThroatSlit(const sstring &, TBeing *);
    void doGuard(const sstring &);
    void doSplit(const sstring &, bool);
    void doReply(const sstring &);
    void doReport(const sstring &);
    ...
    int doQuaff(sstring);
    void reformGroup();
    void doGroup(const sstring &);
    int doRecite(const sstring &);
    int doUse(sstring);
    int doUnsaddle(sstring);
    int doSaddle(sstring);
    int doChop(const sstring &, TBeing *);
    int doHurl(const sstring &, TBeing *);
    int doChi(const sstring &, TThing *);
    int doLeap(const sstring &);
    int doVote(const sstring &);
    int doLayHands(const sstring &);
    int doSmoke(const sstring &);
    void doExtinguish(const sstring &);
    void doLight(const sstring &);
    void doRefuel(const sstring &);
    void doStop(const sstring &);
    void doContinue(const sstring &);
    void doFish(sstring);
    void doHistory();
    int  doCreate(const sstring &);
    ...
    void doCommand(const sstring &);
    int doAssist(const sstring &, TBeing *, bool flags = FALSE);
    void doRoll(TBeing *, dirTypeT);
    void doRoll(TObj *, dirTypeT);
    void doRoll(const sstring &);
    void doEcho(const sstring &);
    void doHighfive(const sstring &);
    virtual void doToggle(const sstring &);
    ...
    int doHide();
    int doSneak(const sstring &);
    void doLoglist(const sstring &, int);
    int doExits(const sstring &, cmdTypeT);
    void doWipe(const sstring &);
    void doReplace(const sstring &);
    void doSetsev(const sstring &);
    void doTimeshift(const sstring &);
    void doInfo(const sstring &);
    void doLog(const sstring &);
    void doHostlog(const sstring &);
    virtual void doShow(const sstring &);
    void doChecklog(const sstring &, int);
    ...
    int doMount(const sstring &, cmdTypeT, TBeing *, silentTypeT silent = SILENT_NO);
    int doJunk(const sstring &, TObj *);
    int doNoJunk(const sstring &, TObj *);
    int doDonate(const sstring &);
    int doSteal(const sstring &, TBeing *);
    void doRestore(const sstring &);
    void doThrow(const sstring &);
    void doWear(const sstring &);
    int stickIn(TThing *o, wearSlotT pos, silentTypeT silent = SILENT_NO);
    int doEmote(const sstring &);
    void doNotHere() const;
    void doWield(const sstring &);
    // psionics
    int doPTell(const sstring &, bool);
    int doPSay(const sstring &);
    void doPShout(const sstring &);
    void doTelevision(const sstring &);
    void doMindfocus(const sstring &);
    int doPsiblast(const sstring &);
    int doMindthrust(const sstring &);
    int doPsycrush(const sstring &);
    int doKwave(const sstring &);
    int doPsidrain(const sstring &);


    // Monk Skills
    int doQuiveringPalm(const sstring &, TBeing *);
    int doSpringleap(sstring, bool, TBeing *);
    int doShoulderThrow(const sstring &, TBeing *);
    int doGrappleMonk(const sstring &, int, TBeing *);
    int doFeignDeath();
    int doMendLimb(const sstring &, int);
    int aiHurl(dirTypeT, TBeing *);
#if 0
    int doFizal(const sstring &, int);
    int doDoubleKick(const sstring &, int, TBeing *);
    int doTripleKick(const sstring &, int, TBeing *);
#endif

    int doDrop(const sstring &, TThing *, bool forceDrop = FALSE);
    int doGet(const sstring &);
    void doGrab(const sstring &);
    int doPut(const sstring &);
    int doKick(const sstring &, TBeing *);
    bool isSaveMob(const TBeing *) const;
    bool isPet(const unsigned int) const;
    bool isElemental() const;
    int doBash(const sstring &, TBeing *);
    int doTrip(const sstring &, TBeing *);
    ...
    void doSave(silentTypeT, const sstring & = NULL);
    void doZonefile(const sstring &);
    void doLoot(const sstring &);
    void saveChar(short int);
    int doFlee(const sstring &);
    int doDisarm(sstring, TThing *);
    int dieReturn(const sstring &, spellNumT, int);
    void doReturn(const sstring &, wearSlotT, bool, bool deleteMob = TRUE);
    int doHit(const sstring &, TBeing *);
    int doEngagedHit(const sstring &, TBeing *);
    int doKill(const sstring &, TBeing *);
    int doEngage(const sstring &, TBeing *);
    int doDisengage();
    int doOrder(const sstring &);
    bool isOrderAllowed(const sstring &);
    virtual int doQuit2() = 0;
    void doQuit();
    void doBruttest(const sstring &);
    int doMove(cmdTypeT);
    int doMove(dirTypeT);
    ...
    void mudMessage(TBeing *, int, const sstring &); 
    ...
    void doRead(const sstring &);
    void doWake(const sstring &);
    int doOpen(const sstring &);
    int doLeave(const sstring &);
    int doEnter(const sstring &, TPortal *);
    void doSit(const sstring &);
    void doRest(const sstring &);
    void doSleep(const sstring &);
    void doClose(const sstring &);
    void doUnlock(const sstring &);
    void doLock(const sstring &);
    void doScore();
    void doTrophy(const sstring &);
    void doWhozone();
    void doWho(const sstring &);
    void doTime(const sstring &);
    void doWizhelp();
    virtual void raiseLevel(classIndT);
    virtual void doUsers(const sstring &);
    void doInventory(const sstring &);
    void doEquipment(const sstring &);
    void doOutfit(const sstring &);
    void doCredits();
    void doNews(const sstring &);
    void doWizlist();
    void doWhere(const sstring &);
    void doLevels(const sstring &);
    void doConsider(const sstring &);
    void immortalEvaluation(const TMonster *) const;
    void doSpelllist(const sstring &, int);
    void doWorld();
    void doAttribute(const sstring &);
    void doClear(const sstring &);
    void doAlias(const sstring &);
    void doGlance(const sstring &);
    void doMotd(const sstring &);
    void doLimbs(const sstring &);
    void describeLimbDamage(const TBeing *) const;
    sstring describeAffects(TBeing *, showMeT) const;
    void doStand();
    void doCrawl();
    void doFollow(const sstring &);
    void doTestCode(const sstring &);
    ...
    int doDisguise(const sstring &);
    int doPoisonWeapon(sstring);
    int doGarrotte(const sstring &, TBeing *);
    int doStab(const sstring &, TBeing *);
    int doCudgel(const sstring &, TBeing *);
    ...
    TThing * findArrow(const sstring &, silentTypeT) const;
