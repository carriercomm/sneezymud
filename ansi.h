...
const sstring ANSI_NORMAL           = "\033[0m";
const sstring ANSI_FLASH            = "\033[5m";
const sstring ANSI_CHECK            = "\033[6n";
const sstring ANSI_BLACK            = "\033[30m";
const sstring ANSI_GRAY             = "\033[1;30m";
const sstring ANSI_RED              = "\033[31m";
const sstring ANSI_RED_BOLD         = "\033[1;31m";
const sstring ANSI_UNDER            = "\033[4m";
const sstring ANSI_GREEN            = "\033[32m";
const sstring ANSI_GREEN_BOLD       = "\033[1;32m";
const sstring ANSI_ORANGE           = "\033[33m";
const sstring ANSI_ORANGE_BOLD      = "\033[1;33m";
const sstring ANSI_YELLOW           = ANSI_ORANGE;
const sstring ANSI_YELLOW_BOLD      = ANSI_ORANGE_BOLD;
const sstring ANSI_BLUE             = "\033[34m";
const sstring ANSI_BLUE_BOLD        = "\033[1;34m";
const sstring ANSI_PURPLE           = "\033[35m";
const sstring ANSI_PURPLE_BOLD      = "\033[1;35m";
const sstring ANSI_CYAN             = "\033[36m";
const sstring ANSI_CYAN_BOLD        = "\033[1;36m";
const sstring ANSI_WHITE            = "\033[37m";
const sstring ANSI_WHITE_BOLD       = "\033[1;37m";

const sstring ANSI_BK_ON_BK   = "\033[8m";             /* black on black text */
const sstring ANSI_BK_ON_WH   = "\033[7m";            /* black on white text */
const sstring ANSI_WH_ON_RD   = "\033[41m";            /* white on red text */
const sstring ANSI_WH_ON_GR   = "\033[42m";            /* white on green text */
const sstring ANSI_WH_ON_OR   = "\033[43m";            /* white on orange text */
const sstring ANSI_WH_ON_BL   = "\033[44m";            /* white on blue text */
const sstring ANSI_WH_ON_PR   = "\033[45m";            /* white on purple text */
const sstring ANSI_WH_ON_CY   = "\033[46m";            /* white on cyan text */

const sstring ANSI_BAR1     = "\260";
const sstring ANSI_BAR2     = "\261";
const sstring ANSI_BAR3     = "\262";
const sstring ANSI_BAR4     = "\333";

const sstring ANSI_BLUE_BAR = "\033[34m\333\033[0m";

const sstring VT_UPARROW    = "\033[A";
const sstring VT_DNARROW    = "\033[B";
const sstring VT_LTARROW    = "\033[D";
const sstring VT_RTARROW    = "\033[C";

const sstring VT_INITSEQ    = "\033[1;24r";          /* fixes up margins */
const sstring VT_CURSPOS    = "\033[%d;%dH";         /* respositions cursor */
const sstring VT_CURSRIG    = "\033[%dC";            /* moves cursor right */
const sstring VT_CURSLEF    = "\033[%dD";           /* moves cursor left */
const sstring VT_HOMECLR    = "\033[2J\033[0;0H";
const sstring VT_CTEOTCR    = "\033[K";
const sstring VT_CLENSEQ    = "\033[r\033[2J";       /* clears and resets screen */
const sstring VT_INVERTT    = "\033[0;1;7m";         /* inverted text */
const sstring VT_BOLDTEX    = "\033[0;1m";           /* bold text */
const sstring VT_NORMALT    = "\033[0m";             /* normal text */
const sstring VT_MARGSET    = "\033[%d;%dr";         /* sets margins */
const sstring VT_CURSAVE    = "\0337";               /* saves cursor position */
const sstring VT_CURREST    = "\0338";               /* restores cursor position */
