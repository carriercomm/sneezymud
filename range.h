...
extern TBeing *get_char_linear(const TBeing *, sstring &, int *, dirTypeT *);
extern TBeing *get_char_vis_direction(const TBeing *, sstring &, dirTypeT, unsigned int, bool, unsigned int *count = NULL);
